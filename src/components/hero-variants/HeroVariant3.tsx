      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="mb-6 text-4xl md:text-6xl font-bold text-gray-900">
            <span className="inline-block animate-[pulse-glow_6s_ease-in-out_infinite] animation-delay-0">
              Connect
            </span>
            .{" "}
            <span className="inline-block animate-[pulse-glow_6s_ease-in-out_infinite] animation-delay-2000">
              Trade
            </span>
            .{" "}
            <span className="inline-block animate-[pulse-glow_6s_ease-in-out_infinite] animation-delay-4000">
              Deliver
            </span>
            .
            <br />
