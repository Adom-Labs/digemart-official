...
// Variant 4: Background Highlight Slide
const HeroVariant4 = () => {
  const features = [
    "Verified Stores",
    "Secure Payments",
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="mb-6 text-4xl md:text-6xl font-bold text-gray-900">
            <span className="relative inline-block px-2 animate-[bg-slide_6s_ease-in-out_infinite] animation-delay-0">
              Connect
            </span>
            .{" "}
            <span className="relative inline-block px-2 animate-[bg-slide_6s_ease-in-out_infinite] animation-delay-2000">
              Trade
            </span>
            .{" "}
            <span className="relative inline-block px-2 animate-[bg-slide_6s_ease-in-out_infinite] animation-delay-4000">
              Deliver
            </span>
            .
            <br />
