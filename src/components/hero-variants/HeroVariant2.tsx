...
// Variant 2: Gradient Wave Animation
const HeroVariant2 = () => {
  const features = [
    "Verified Stores",
    "Secure Payments",
      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <h1 className="mb-6 text-4xl md:text-6xl font-bold">
            <span className="inline-block bg-gradient-to-r from-blue-600 via-purple-600 to-blue-600 bg-[length:200%_auto] animate-gradient bg-clip-text text-transparent">
