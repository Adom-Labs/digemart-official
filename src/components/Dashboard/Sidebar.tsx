...
export function Sidebar({
  ...
  const navItems = [
    ...
    },
    {
      icon: BarChart3Icon,
      label: "Analytics",
      path: "/findyourplug/dashboard/analytics",
    },
    {
      icon: SettingsIcon,
      label: "Settings",
      path: "/findyourplug/dashboard/settings",
    },
  ];
  ...
  return (
    <aside
      className={`fixed left-0 top-0 h-screen bg-background border-r border-border transition-transform duration-300 z-50 w-[280px] ${
          ...
          <div className="px-4 pb-4">
            <div className="flex items-center gap-3">
              ...
              <div className="flex-1">
                ...
                <Badge className={`${intentBadge.color} text-xs mt-1`}>
                  {intentBadge.label}
                </Badge>
              </div>
            </div>
          ...
          <nav className="flex-1 px-3 py-4">
            <div className="space-y-1">
              {navItems.map((item) => {
                const isActive =
                  pathname === item.path ||
                  (item.path !== "/findyourplug/dashboard" &&
