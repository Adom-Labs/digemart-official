...
import { StoreIcon, ShoppingCartIcon, BarChart3Icon, ArrowRightIcon } from 'lucide-react';
...
export function QuickActionsGrid({ viewMode = 'all' }: QuickActionsGridProps) {
    const allActions = [
        {
            ...
            description: 'Add your business to local directories and reach more customers',
            cta: 'Create Listing',
        ...
        },
        {
            ...
            description: 'Track performance metrics and insights across all your stores',
            cta: 'View Analytics',
            color: 'text-blue-600',
    ...
    const getFilteredActions = () => {
        if (viewMode === 'listings') {
            return allActions.filter(action => action.type === 'listing' || action.type === 'general');
        } else if (viewMode === 'ecommerce') {
            return allActions.filter(action => action.type === 'ecommerce' || action.type === 'general');
        }
        return allActions;
    };
        ...
        <section className="mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {actions.map((action) => (
                    ...
                    >
                        <CardHeader>
                            <div className={`w-12 h-12 rounded-lg bg-gray-100 flex items-center justify-center mb-4 ${action.color}`}>
