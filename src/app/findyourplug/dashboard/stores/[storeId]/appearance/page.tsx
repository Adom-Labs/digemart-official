...
interface StoreAppearancePageProps {
  params: {
    storeId: string;
  };
}
...
export default function StoreAppearancePage({ params }: StoreAppearancePageProps) {
  ...
  return (
    <div className="container mx-auto px-4 py-6">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-3">
            ...
            <div>
              <h1 className="text-3xl font-bold text-gray-900">Store Appearance</h1>
              <p className="text-gray-600 mt-1">
                Customize the look and feel of {store.storeName}
              </p>
            </div>
          </div>
      ...
      {/* Appearance Manager */}
      <StoreAppearanceManager store={store} />
    </div>
  );
}